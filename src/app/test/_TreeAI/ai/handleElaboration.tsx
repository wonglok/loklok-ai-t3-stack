...
import { toChatStream } from "./toChatStream";
import { getFreeAIAsync } from "./getFreeAIAsync";
import { writeFileContent } from "../io/writeFileContent";

export const handleElaboration = async () => {
    //
    useTreeAI.setState({
        atLeastOneWorkerRunning: true,
    });
    //
    ...
    uiMessages.push(newUserMessage);

    const model = await getFreeAIAsync();
...
Generate the "Product Requirement Definition" starting with Step 1, and output it as a complete design based on the provided requirements.
    ...
    uiMessages.push(progressMessage);
